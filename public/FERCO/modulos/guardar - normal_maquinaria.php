...
else if (isset($_POST["Materiales_Crear"]))
{
	...
	else
	{
		...
		else
		{
			...
			valor_km, uso, notas, imagen, digitado_por, fecha_digitado) VALUES ('".$Codigo."', '".$Codigo2."', '".$Nombre."', 'Maquinaria', 
...
else if (isset($_POST["Equipos_Crear"]))
{
	...
	else
	{
		...
		else
		{
			...
			notas, imagen, digitado_por, fecha_digitado) VALUES ('".$Codigo."', '".$Codigo2."', '".$Nombre."', 'Maquinaria', '".$Grupo."', 
	...
	if (ExtractFile("../Uploads_Tmp/".$File, $Extension, $Today))
	{
		...
		if (isset($DataDBF))
		{
			...
			for ($i = 0; $i < count($EQU_Array); $i++)
			{
				...
				'".$EQU_Array[$i]["DESEQU"]."', 'Materiales', '".$Grupo."', '".$SubGrupo."', '".$EQU_Array[$i]["UNIEQU"]."', 
