...
else if (isset($_GET['Compras_Modificar']))
{
	...
	estado = 'Cotizacion' AND digitado_por LIKE '%".$UserCode."%'";
	$result = mysql_query($query) or die($DEBUG ? "SQL ERROR #1: ".mysql_error():"");
	if (mysql_num_rows($result) > 0)
	{
		while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
...
else if (isset($_GET['Ventas_Ajustar']))
{
	...
	$Fecha_Ini = date('Y-m-d', strtotime('-1 year'));
...
else if (isset($_GET['Cartera_Movimientos']))
{
	...
	if (mysql_num_rows($result) > 0)
	{
		...
		//foreach ($tmp as $row)
		{
			/*if ($row["cliente_id"] != $last_id)
			{
				$last_id = $row["cliente_id"];
				foreach($array as $row1)
				{
					if ($row1["cliente_id"] == $row["cliente_id"])
					{
						$Nombre = $row1["nombre"];
						break;
					}
	...
	//echo "<br />Tiempo Transcurrido -> ".(time() - $now)." Total ->".mysql_num_rows($result);
}
...
else if (isset($_GET['Cartera_Edades']))
{
	...
	$ClienteNombre = ClientesNombre();
	$data = BuscarClientesDeudores($ClienteID, $CobradorID);
	$num = count($data);
	...
	if ($num > 0)
	{
		...
		foreach($data as $item)
		{
			$newdata[] = array(
				...
				"ClienteID" => $item["ClienteID"],
				"CobradorID" => isset($Cobradores[$item["ClienteID"]]) ? $Cobradores[$item["ClienteID"]]:"No Existe!",
				"Deuda" => $Deuda[$item["ClienteID"]],
...
else if (isset($_GET['Caja_Aprobar']))
{
	...
	$query .= (isset($_GET['Estado']) && $_GET['Estado'] != "") ? " AND estado = '".$_GET['Estado']."'":"";
	$query .= (isset($_GET['ClienteID']) && $_GET['ClienteID'] != "") ? " AND cliente_id = '".$_GET['ClienteID']."'":"";
	$query .= (isset($_GET['ReciboCaja']) && $_GET['ReciboCaja'] != "") ? " AND caja_recibo LIKE '%".$_GET['ReciboCaja']."%'":"";
	...
	if (mysql_num_rows($result)>0) {
		...
		while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
		{
			$data[] = array (
				...
				'CajaInterno' => $row['caja_interno'],
				'ReciboCaja' => $row['caja_recibo'],
				'Dprov' => $row['cxp'],
				'Total' => $row['total'],
				'DigitadorID' => $row['digitado_por'],
				'Tipo' => $row['categoria'],
...
else if (isset($_GET['Nomina']))
{
	...
	if (isset($Nomina[0]["ClienteID"]))
	{
		...
		$query .= ($Estado != "" && $Estado != "\"\"") ? "AND estado = '".$Estado."'":"";
		...
		if(mysql_num_rows($result) > 0)
		{
			while($row = mysql_fetch_array($result))
			{
				...
				if ($Quincenal == true)
				{
					...
					{
						// Descuento Autorizado
						$Salud2 = $BasicoFinal2 * $SaludValor;//0.04;
						$Pension2 = $BasicoFinal2 * $PensionValor;//0.04;
					}
...
else if (isset($_GET["Presupuesto_Importar"]))
{
	...
	if (ExtractFile("../Uploads_Tmp/presupuesto.rar", "rar", $Today))
	{
			...
			for ($i = 0; $i < count($TmpDataArray); $i++)
			{
				...
				switch($TmpDataArray[$i]["Type"])
				{
					case "BAS":
						...
						echo $TmpDataArray[$i]["Data"]["CODUNI_F"]."<br />";
						echo $TmpDataArray[$i]["Data"]["TIPUNI_F"]."<br />";
						echo $TmpDataArray[$i]["Data"]["TIPOBAS"]."<br />";
						echo $TmpDataArray[$i]["Data"]["CODBAS"]."<br />";
						echo $TmpDataArray[$i]["Data"]["CANBAS"]."<br />";
						echo "<br />";
						
					break;
					
					case "UNI":
						echo $TmpDataArray[$i]["Data"]["CODMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESANA"]."<br />";
						echo $TmpDataArray[$i]["Data"]["UNIANA"]."<br />";
						echo $TmpDataArray[$i]["Data"]["VALANA"]."<br />";
						echo $TmpDataArray[$i]["Data"]["OBSANA"]."<br />";
						echo $TmpDataArray[$i]["Data"]["GRUPO"]."<br />";
						echo "<br />";
					break;
					
					case "GRU":
						echo $TmpDataArray[$i]["Data"]["CODGRUU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESGRUU"]."<br />";
						echo "<br />";
					break;
					
					case "GRM":
						echo $TmpDataArray[$i]["Data"]["CODGRUM"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESGRUM"]."<br />";
						echo "<br />";
					break;
					
					case "MAT":
						echo $TmpDataArray[$i]["Data"]["FECMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["GRUPOMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["CODMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["UNIMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["VALMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["OBSMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["CANMAT"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV1"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV2"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV3"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV4"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV5"]."<br />";
						echo "<br />";
					break;
					
					case "MAN":
						echo $TmpDataArray[$i]["Data"]["CODMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["UNIMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["JORMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PORMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["OBSMAN"]."<br />";
						echo $TmpDataArray[$i]["Data"]["FECMAN"]."<br />";
						echo "<br />";
					break;
					
					case "EQU":
						echo $TmpDataArray[$i]["Data"]["CODEQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["DESEQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["UNIEQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["TAREQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["FECEQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["OBSEQU"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV1"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV2"]."<br />";
						echo $TmpDataArray[$i]["Data"]["PROV3"]."<br />";
						echo $TmpDataArray[$i]["Data"]["CANEQU"]."<br />";
						echo "<br />";
					break;
...
else if (isset($_GET['Imprimir_Compra']))
{
	...
	$query = "SELECT compras_final.*, compras_movs.*, clientes.nombre, clientes.tipo_doc, clientes.direccion, clientes.telefono, 
	productos.nombre AS nombre_producto, productos.peso FROM compras_final LEFT JOIN compras_movs ON compras_final.interno = compras_movs.interno 
	LEFT JOIN clientes ON compras_final.cliente_id = clientes.cliente_id LEFT JOIN productos ON productos.cod_fab = compras_movs.codigo 
