...
$(document).ready(function ()
{
	...
	function SaveData(Generar)
	{
		...
		if (Generar)
		{
			if (Venta_Interno != "" || OP != "")
			{
				Alerts_Box("Esta Cartilla ya posee una Cotizacion Enlazada, no es posible volver a generar una Cotizacion.", 3);
				WaitClick();
				Locked = false;
				return;
			}
	...
	<table cellpadding="2" cellspacing="1" style="margin-bottom:15px; width:999px;">
		...
		<tr>
			<td colspan="3">
				...
				<li style="margin-left:4px;">
					<input type="button" id="figuracion_modificar_venta" value="Cotizacion"/>
				</li>
			</td>
		</tr>
		<tr>
