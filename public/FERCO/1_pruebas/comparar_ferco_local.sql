...
-- ----------------------------
-- Table structure for apu_clasificacion
-- ----------------------------
DROP TABLE IF EXISTS `apu_clasificacion`;
CREATE TABLE `apu_clasificacion` (
...
-- ----------------------------
-- Table structure for apu_equ_originales
-- ----------------------------
DROP TABLE IF EXISTS `apu_equ_originales`;
CREATE TABLE `apu_equ_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `apu_equ_originales_codigo` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_equ_originales_prov
-- ----------------------------
DROP TABLE IF EXISTS `apu_equ_originales_prov`;
CREATE TABLE `apu_equ_originales_prov` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `proveedor_id` varchar(100) NOT NULL DEFAULT '',
  `proveedor_codigo` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `apu_equ_originales_codigo` (`codigo`),
  CONSTRAINT `apu_equ_originales_codigo` FOREIGN KEY (`codigo`) REFERENCES `apu_equ_originales` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_mat_originales
-- ----------------------------
DROP TABLE IF EXISTS `apu_mat_originales`;
CREATE TABLE `apu_mat_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `codigo2` varchar(100) NOT NULL DEFAULT '',
  `nombre` varchar(100) NOT NULL DEFAULT '',
  ...
  `valor` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor_km` decimal(20,2) NOT NULL DEFAULT '0.00',
  `uso` decimal(20,2) NOT NULL DEFAULT '0.00',
  `notas` varchar(100) NOT NULL DEFAULT '',
  `fecha` date NOT NULL DEFAULT '0000-00-00',
  `imagen` varchar(100) NOT NULL DEFAULT '',
  ...
  `fecha_modificado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `apu_mat_originales_codigo` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=4581 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_mat_originales_prov
-- ----------------------------
DROP TABLE IF EXISTS `apu_mat_originales_prov`;
CREATE TABLE `apu_mat_originales_prov` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `proveedor_id` varchar(100) NOT NULL DEFAULT '',
  `proveedor_codigo` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `apu_mat_originales_codigo` (`codigo`),
  CONSTRAINT `apu_mat_originales_codigo` FOREIGN KEY (`codigo`) REFERENCES `apu_mat_originales` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4496 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_mo_originales
-- ----------------------------
DROP TABLE IF EXISTS `apu_mo_originales`;
CREATE TABLE `apu_mo_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `codigo2` varchar(100) NOT NULL DEFAULT '',
  `nombre` varchar(100) NOT NULL DEFAULT '',
  ...
  `unidad` varchar(100) NOT NULL DEFAULT '',
  `uso` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor_sc` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor_pd` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor_scc` decimal(20,2) NOT NULL DEFAULT '0.00',
  `notas` varchar(100) NOT NULL DEFAULT '',
  `fecha` date NOT NULL DEFAULT '0000-00-00',
  `digitado_por` varchar(100) NOT NULL DEFAULT '',
  `fecha_digitado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `fecha_modificado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `apu_mo_originales_codigo` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_mo_originales_movs
-- ----------------------------
DROP TABLE IF EXISTS `apu_mo_originales_movs`;
CREATE TABLE `apu_mo_originales_movs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  ...
  `fijo` enum('true','false') NOT NULL DEFAULT 'false',
  PRIMARY KEY (`id`),
  KEY `apu_mo_originales_codigo` (`codigo`),
  CONSTRAINT `apu_mo_originales_codigo` FOREIGN KEY (`codigo`) REFERENCES `apu_mo_originales` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_originales
-- ----------------------------
DROP TABLE IF EXISTS `apu_originales`;
CREATE TABLE `apu_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `codigo2` varchar(100) NOT NULL DEFAULT '',
  `nombre` varchar(100) NOT NULL DEFAULT '',
  ...
  `subgrupo` varchar(100) NOT NULL DEFAULT '',
  `unidad` varchar(100) NOT NULL DEFAULT '',
  `desperdicios` decimal(20,2) NOT NULL DEFAULT '0.00',
  `gastos` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor` decimal(20,2) NOT NULL DEFAULT '0.00',
  `digitado_por` varchar(100) NOT NULL DEFAULT '',
  `fecha_digitado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modificado_por` varchar(100) NOT NULL DEFAULT '',
  ...
  `notas` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `apu_originales_codigo` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=1205 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for apu_originales_movs
-- ----------------------------
DROP TABLE IF EXISTS `apu_originales_movs`;
CREATE TABLE `apu_originales_movs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `objeto_codigo` varchar(100) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`),
  KEY `apu_originales_codigo` (`codigo`),
  CONSTRAINT `apu_originales_codigo` FOREIGN KEY (`codigo`) REFERENCES `apu_originales` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6193 DEFAULT CHARSET=latin1;
...
CREATE TABLE `bancos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8428 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `caja_final` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30856 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=8226 DEFAULT CHARSET=latin1;
...
CREATE TABLE `clientes_garant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29196 DEFAULT CHARSET=latin1;
...
CREATE TABLE `cliente_grupo` (
  ...
  `grupo` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6953 DEFAULT CHARSET=latin1;
...
CREATE TABLE `compras_final` (
  ...
  `fecha_aprobado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10286 DEFAULT CHARSET=latin1;
...
CREATE TABLE `compras_movs` (
  ...
  `cliente_id` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4154 DEFAULT CHARSET=latin1;
...
CREATE TABLE `cxp_movs` (
  ...
  `subgrupo2` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33141 DEFAULT CHARSET=latin1;
...
CREATE TABLE `fact_movs` (
  ...
  `cliente_id` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2105561 DEFAULT CHARSET=latin1;
...
CREATE TABLE `import_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3895 DEFAULT CHARSET=latin1;
...
CREATE TABLE `inventario_movs` (
  ...
  `estado` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=139692 DEFAULT CHARSET=latin1;
...
CREATE TABLE `login` (
  ...
  `user_lvl` enum('General','Administrador','Vendedor') NOT NULL DEFAULT 'General',
  `active` enum('true','false') NOT NULL DEFAULT 'true',
...
CREATE TABLE `maquinaria_partes` (
  ...
  `problema` varchar(256) NOT NULL DEFAULT '',
  `diagnostico` varchar(256) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for max_users
-- ----------------------------
...
CREATE TABLE `mov_clientes` (
  ...
  `caja_recibo` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=132073 DEFAULT CHARSET=latin1;
...
CREATE TABLE `nomina` (
  ...
  `deuda` decimal(20,2) NOT NULL DEFAULT '0.00',
...
-- ----------------------------
-- Table structure for par_presupuesto_categoria
-- ----------------------------
DROP TABLE IF EXISTS `par_presupuesto_categoria`;
CREATE TABLE `par_presupuesto_categoria` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `categoria` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
-- ----------------------------
-- Table structure for par_presupuesto_conceptos
-- ----------------------------
DROP TABLE IF EXISTS `par_presupuesto_conceptos`;
CREATE TABLE `par_presupuesto_conceptos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `concepto` varchar(100) NOT NULL DEFAULT '',
  `uso` decimal(20,2) NOT NULL DEFAULT '0.00',
  `valor` decimal(20,2) NOT NULL DEFAULT '0.00',
...
-- ----------------------------
-- Table structure for par_presupuesto_grupo_originales
-- ----------------------------
DROP TABLE IF EXISTS `par_presupuesto_grupo_originales`;
CREATE TABLE `par_presupuesto_grupo_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `grupo` varchar(100) NOT NULL DEFAULT '',
  `categoria` varchar(100) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for par_presupuesto_subgrupo_originales
-- ----------------------------
DROP TABLE IF EXISTS `par_presupuesto_subgrupo_originales`;
CREATE TABLE `par_presupuesto_subgrupo_originales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(100) NOT NULL DEFAULT '',
  `subgrupo` varchar(100) NOT NULL DEFAULT '',
  `grupo` varchar(100) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for par_presupuesto_unidad
-- ----------------------------
DROP TABLE IF EXISTS `par_presupuesto_unidad`;
CREATE TABLE `par_presupuesto_unidad` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unidad` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for par_ter_vend - se cambio por login system
-- ----------------------------
DROP TABLE IF EXISTS `par_ter_vend - se cambio por login system`;
CREATE TABLE `par_ter_vend - se cambio por login system` (
  `id` int(11) NOT NULL,
  `codigo` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `vendedor` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `vendedor_id` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `presupuesto` (
  ...
  `fecha_modificado` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `presupuesto_interno` (`interno`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE `presupuesto_movs` (
  ...
  `clasificacion` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `presupuesto_interno` (`interno`),
  CONSTRAINT `presupuesto_interno` FOREIGN KEY (`interno`) REFERENCES `presupuesto` (`interno`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `produccion_proc_movs` (
  ...
  `cliente_id` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13130 DEFAULT CHARSET=latin1;
...
DROP TRIGGER IF EXISTS `update_apu_movs_A-U_apu_equ_originales`;
DELIMITER ;;
CREATE TRIGGER `update_apu_movs_A-U_apu_equ_originales` AFTER UPDATE ON `apu_equ_originales` FOR EACH ROW BEGIN	UPDATE `apu_originales_movs` SET objeto_codigo = NEW.codigo, valor = NEW.valor, total = (((NEW.valor * cantidad) /100) * uso) WHERE tipo = 'Equipos' AND objeto_codigo = OLD.codigo; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_apu_movs_A-U_apu_mat_originales`;
DELIMITER ;;
CREATE TRIGGER `update_apu_movs_A-U_apu_mat_originales` AFTER UPDATE ON `apu_mat_originales` FOR EACH ROW BEGIN	UPDATE `apu_originales_movs` SET objeto_codigo = NEW.codigo, valor = NEW.valor, total = (((NEW.valor * cantidad) /100) * uso) WHERE tipo = 'Materiales' AND objeto_codigo = OLD.codigo; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_apu_movs_A-U_apu_mo_originales`;
DELIMITER ;;
CREATE TRIGGER `update_apu_movs_A-U_apu_mo_originales` AFTER UPDATE ON `apu_mo_originales` FOR EACH ROW BEGIN	UPDATE `apu_originales_movs` SET objeto_codigo = NEW.codigo, valor = NEW.valor_scc, total = (((NEW.valor_scc * cantidad) /100) * uso) WHERE tipo = 'Mano de Obra' AND objeto_codigo = OLD.codigo; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_presupuesto_A-U_apu_originales`;
DELIMITER ;;
CREATE TRIGGER `update_presupuesto_A-U_apu_originales` AFTER UPDATE ON `apu_originales` FOR EACH ROW BEGIN	IF NEW.codigo != OLD.codigo THEN 		UPDATE presupuesto_movs SET codigo = NEW.codigo WHERE codigo = OLD.codigo; 	END IF; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_apu_A-U_apu_originales_movs`;
DELIMITER ;;
CREATE TRIGGER `update_apu_A-U_apu_originales_movs` AFTER UPDATE ON `apu_originales_movs` FOR EACH ROW BEGIN	DECLARE p_desp decimal(20, 2); 	DECLARE total_desp decimal(20, 2); 	DECLARE p_gast decimal(20, 2); 	DECLARE total_gast decimal(20, 2); 	DECLARE total_apu decimal(20, 2); 	DECLARE total_mat decimal(20, 2); 	DECLARE total_mo decimal(20, 2); 	DECLARE total_equ decimal(20, 2); 	DECLARE total_final decimal(20, 2); 	SELECT desperdicios INTO p_desp FROM `apu_originales` WHERE codigo = NEW.codigo; 	SELECT gastos INTO p_gast FROM `apu_originales` WHERE codigo = NEW.codigo; 	SELECT SUM(total) INTO total_apu FROM `apu_originales_movs` WHERE tipo = 'APU' AND codigo = NEW.codigo; 	SELECT SUM(total) INTO total_mat FROM `apu_originales_movs` WHERE tipo = 'Materiales' AND codigo = NEW.codigo; 	SELECT SUM(total) INTO total_mo FROM `apu_originales_movs` WHERE tipo = 'Mano de Obra' AND codigo = NEW.codigo; 	SELECT SUM(total) INTO total_equ FROM `apu_originales_movs` WHERE tipo = 'Equipos' AND codigo = NEW.codigo; 	SET total_desp := ((total_mat / 100) * p_desp); 	SET total_gast := ((total_mo / 100) * p_gast); 	IF ISNULL(total_desp) THEN SET total_desp := 0; END IF; 	IF ISNULL(total_gast) THEN SET total_gast := 0; END IF; 	IF ISNULL(total_apu) THEN SET total_apu := 0; END IF; 	IF ISNULL(total_mat) THEN SET total_mat := 0; END IF; 	IF ISNULL(total_mo) THEN SET total_mo := 0; END IF; 	IF ISNULL(total_equ) THEN SET total_equ := 0; END IF; 	SET total_final := total_desp + total_gast + total_apu + total_mat + total_mo + total_equ; 	UPDATE `apu_originales` SET valor = total_final WHERE codigo = NEW.codigo; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_groups_A-U_originales`;
DELIMITER ;;
CREATE TRIGGER `update_groups_A-U_originales` AFTER UPDATE ON `par_presupuesto_grupo_originales` FOR EACH ROW BEGIN	IF NEW.codigo != OLD.codigo THEN BEGIN 		IF NEW.categoria = 'APU' THEN 			UPDATE `apu_originales` SET codigo = CONCAT(NEW.codigo, '.', subgrupo, '.', codigo2), grupo = NEW.codigo WHERE grupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Materiales' THEN 			UPDATE `apu_mat_originales` SET codigo = CONCAT(NEW.codigo, '.', subgrupo, '.', codigo2), grupo = NEW.codigo WHERE grupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Equipos' THEN 			UPDATE `apu_equ_originales` SET codigo = CONCAT(NEW.codigo, '.', subgrupo, '.', codigo2), grupo = NEW.codigo WHERE grupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Mano de Obra' THEN 			UPDATE `apu_mo_originales` SET codigo = CONCAT(NEW.codigo, '.', subgrupo, '.', codigo2), grupo = NEW.codigo WHERE grupo = OLD.codigo; 		END IF; 		UPDATE `par_presupuesto_subgrupo_originales` SET grupo = NEW.codigo WHERE grupo = OLD.codigo AND categoria = OLD.categoria; 	END; END IF; END
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `update_subgroups_A-U_originales`;
DELIMITER ;;
CREATE TRIGGER `update_subgroups_A-U_originales` AFTER UPDATE ON `par_presupuesto_subgrupo_originales` FOR EACH ROW BEGIN	IF NEW.codigo != OLD.codigo THEN BEGIN 		IF NEW.categoria = 'APU' THEN 			UPDATE `apu_originales` SET codigo = CONCAT(grupo, '.', NEW.codigo, '.', codigo2), subgrupo = NEW.codigo WHERE grupo = OLD.grupo AND subgrupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Materiales' THEN 			UPDATE `apu_mat_originales` SET codigo = CONCAT(grupo, '.', NEW.codigo, '.', codigo2), subgrupo = NEW.codigo WHERE grupo = OLD.grupo AND subgrupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Equipos' THEN 			UPDATE `apu_equ_originales` SET codigo = CONCAT(grupo, '.', NEW.codigo, '.', codigo2), subgrupo = NEW.codigo WHERE grupo = OLD.grupo AND subgrupo = OLD.codigo; 		END IF; 		IF NEW.categoria = 'Mano de Obra' THEN 			UPDATE `apu_mo_originales` SET codigo = CONCAT(grupo, '.', NEW.codigo, '.', codigo2), subgrupo = NEW.codigo WHERE grupo = OLD.grupo AND subgrupo = OLD.codigo; 		END IF; 	END; END IF; END
;;
DELIMITER ;
