...
$(document).ready(function ()
{
	...
	if ("<?php echo $Interno; ?>" != "")
	{
		$.ajax({
			...
			data: {"Mallas_Imprimir":"<?php echo $Interno; ?>"},
			success: function (data, status, xhr)
			{
				...
				if (data[0]["Items"] != undefined)
				{
					...
					for (var i = 0; i < data[0]["Items"].length; i++)
					{
						...
						//table += "			<div id='"+contenedor+"' style='width:180px; height:100px;'></div>";
						table += "			<b>Dim. en A:</b> Arr: "+data[0]["Items"][i]["arrA"]+", Fin: "+data[0]["Items"][i]["finA"]+", S: "+data[0]["Items"][i]["sepA"]+"<br/>";
						table += "			<b>Dim. en B:</b> Arr: "+data[0]["Items"][i]["arrB"]+", Fin: "+data[0]["Items"][i]["finB"]+", S: "+data[0]["Items"][i]["sepB"]+"";
						table += "		</td>";
						...
						table += "		</td>";
						table += "		<td style=\"border-bottom:#A9A9A9 1px solid; border-right:#A9A9A9 1px solid; text-align:right;\">";
						table += "			"+(varA*cantidadF).toLocaleString('es-ES', { minimumFractionDigits: '0', maximumFractionDigits: '3' })+"";
						table += "		</td>";
						table += "		<td style=\"border-bottom:#A9A9A9 1px solid; border-right:#A9A9A9 1px solid; text-align:left;\">";
						...
						table += "		</td>";
						table += "		<td style=\"border-bottom:#A9A9A9 1px solid; border-right:#A9A9A9 1px solid; text-align:right;\">";
						table += "			"+(varB*cantidadF).toLocaleString('es-ES', { minimumFractionDigits: '0', maximumFractionDigits: '3' })+"";
						table += "		</td>";
					...
					// setTimeout(function(){
						...
						// {
							...
							// setTimeout(function(){
								...
								// for (i = 1; i < 4; i++) { 				
									// renderer.line(10, 25*i, 170, 25*i, { stroke: 'red', 'stroke-width': 1 });
								// }
								// for (i = 1; i < 4; i++) { 				
									// renderer.line(35*i, 10, 35*i, 90, { stroke: 'blue', 'stroke-width': 1 });
								// }
								// console.log(contenedorx);
							// }, 10);
						// }
					// }, 3000);
	...
	// setTimeout(function(){ 
	// $('#content0').jqxDraw();
	// var renderer = $('#content0').jqxDraw('getInstance');
	// var size = renderer.getSize();
	...
	// $('#content1').jqxDraw();
	// var renderer = $('#content1').jqxDraw('getInstance');
	// var size = renderer.getSize();
	...
	<table class="table1" cellspacing="1" cellpadding="1" style="text-align: center;">
		...
		<tr>
			...
			<td colspan="2" style="text-align:left">
				<input type="text" id="total_peso" style="width: 125px; height: 20px; text-align:right; background: rgba(255, 140, 0, 0.52); font-weight: 700" class="myinput" readonly/>
			</td>
			<td>
				Obra
			</td>
