...
$(document).ready(function ()
{
	...
	if ("<?php echo $Interno; ?>" != "")
	{
		$.ajax({
			...
			data: {"Figuracion_Imprimir":"<?php echo $Interno; ?>"},
			success: function (data, status, xhr)
			{
				...
				if (data[0]["Items"] != undefined)
				{
					...
					for (var i = 0; i < data[0]["Items"].length; i++)
					{
						...
						table += "			<img src=\"../images/"+data[0]["Items"][i]["Figura"]+"\"/>";
						table += "		</td>";
						...
						table += "		</td>";
						table += "		<td style=\"border-bottom:#A9A9A9 1px solid; border-right:#A9A9A9 1px solid; text-align:right;\">";
						table += "			"+Peso.toLocaleString('es-ES', { minimumFractionDigits: '2', maximumFractionDigits: '3' });
						table += "		</td>";
