...
$(document).ready(function ()
{
	...
	$.ajax({
		...
		success: function (data, status, xhr)
		{
			...
			table += "</table>";
			$("#total_deuda").val("$ "+data[len-1]["Total_Deuda"]);
			$("#total_a30").val("$ "+data[len-1]["Total_A30"]);
			$("#total_a60").val("$ "+data[len-1]["Total_A60"]);
			$("#total_a90").val("$ "+data[len-1]["Total_A90"]);
			$("#total_mas90").val("$ "+data[len-1]["Total_Mas90"]);
...
<div>
	<div id="header">
		...
		<li style="padding:7px 0px; margin-left: 220px;">
			Edades CxP Proveedores
		</li>
	...
	<table class="table1" cellspacing="1" cellpadding="1" style="text-align:center;">
		<tr>
			...
			<td>
				Total a Mas de 90 Dias
			</td>
		</tr>
		<tr>
			<td>
				<input type="text" id="total_deuda" style="width: 160px; height: 20px; text-align:right;" class="myinput" readonly/>
			</td>
			<td>
				<input type="text" id="total_a30" style="width: 160px; height: 20px; text-align:right;" class="myinput" readonly/>
			</td>
			<td>
				<input type="text" id="total_a60" style="width: 160px; height: 20px; text-align:right;" class="myinput" readonly/>
			</td>
			<td>
				<input type="text" id="total_a90" style="width: 160px; height: 20px; text-align:right;" class="myinput" readonly/>
			</td>
			<td>
				<input type="text" id="total_mas90" style="width: 160px; height: 20px; text-align:right;" class="myinput" readonly/>
			</td>
		</tr>
	</table>
	<div id="mid">
