<?php
	...
	$Tipo = isset($_GET['ClienteID']) ? $_GET['ClienteID']:"";
	$Motivo = isset($_GET['TipoMovimiento']) ? $_GET['TipoMovimiento']:"";
...
$(document).ready(function ()
{
	...
	{
		var data = "";
		data += "../modulos/export_xls.php?Inventario_Recientes=true&Tipo=<?php echo $Tipo; ?>&Motivo=<?php echo $Motivo; ?>";
