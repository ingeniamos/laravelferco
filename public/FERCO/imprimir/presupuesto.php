<?php
	...
	$Month = isset($_GET["Month"]) ? true:false;
?>
...
$(document).ready(function ()
{
	...
	if ("<?php echo $Interno; ?>" != "")
	{
		$.ajax({
			...
			data: {"Presupuesto_Cargar":"<?php echo $Interno; ?>"},
			success: function (data, status, xhr)
			{
				var table = "";
				table += "<table class=\"table2\" cellspacing=\"0\" cellpadding=\"2\">";
				table += "	<tr style=\"background: #DEDEDE; font-size: 13px;\">";
				table += "		<td style=\"border-bottom:#A9A9A9 1px solid; width:8%;\">";
				table += "			Item";
				table += "		</td>";
				table += "		<td style=\"border-bottom:#A9A9A9 1px solid; width:47%;\">";
				table += "			Nombre";
				table += "		</td>";
				table += "		<td style=\"border-bottom:#A9A9A9 1px solid; width:5%;\">";
				table += "			Unidad";
				table += "		</td>";
				table += "		<td style=\"border-bottom:#A9A9A9 1px solid; width:8%;\">";
				table += "			Cantidad";
...
<div>
	<div id="header">
		...
		<li style="padding:7px 0px; margin-left: 100px;">
			Presupuesto
		</li>
		<li style="padding:2px 0px; margin-left: 90px;">
	...
	<table class="table1" cellspacing="1" cellpadding="1">
		<tr>
			...
			<td>
				<input type="text" id="cliente_ID" style="width: 110px; height: 20px;" class="myinput" readonly/>
			</td>
		</tr>
		<tr>
			<td>
	...
	<table class="table3" cellspacing="0" cellpadding="1">
		...
		<tr>
			<td colspan="2" rowspan="4">
				<textarea readonly rows="5" cols="45" id="observaciones" maxlength="200" style="resize:none; margin-right: 80px;"></textarea>
			</td>
			<td>
				Administracion
			</td>
			...
			<td>
				<input type="text" id="administracion2" style="width:120px; text-align:right;" class="myinput" readonly/>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" id="imprevistos2" style="width:120px; text-align:right;" class="myinput" readonly/>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" id="utilidades2" style="width:120px; text-align:right;" class="myinput" readonly/>
			</td>
		</tr>
		<tr>
			<td>
