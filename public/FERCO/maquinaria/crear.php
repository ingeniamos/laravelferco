...
$(document).ready(function ()
{
	...
	if (isset($_SESSION["UserID"]) && $_SESSION["UserID"] != "")
	{
		...
		if ($data[0]["Lvl"] != "Administrador")
		{
			for ($i = 0; $i < $num; $i++)
			{
				if ($data[$i]["Modulo"] == "Maquinaria" && $data[$i]["SubModulo"] == "Crear" && $data[$i]["Guardar"] == "true")
				{
		?>
					Guardar = true;
		<?php
				...
				if ($data[$i]["Modulo"] == "Ventas" && $data[$i]["SubModulo"] == "Crear" && $data[$i]["Imprimir"] == "true")
				{
		?>
					Imprimir = true;
		<?php
	...
	function ReDefine()
	{
		ClearJSON = [
			...
			{id:"maquinaria_crear_estado<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			{id:"maquinaria_crear_operador<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			{id:"maquinaria_crear_mecanico<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			...
			{id:"maquinaria_crear_partes<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			{id:"maquinaria_crear_partes_problema<?php echo $NumOfID; ?>", type:""},
			{id:"maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>", type:""},
			{id:"maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>", type:"jqxGrid"},
			//
			...
			{id:"maquinaria_crear_factura_proveedor1<?php echo $NumOfID; ?>", type:""},
			...
			{id:"maquinaria_crear_factura_proveedor2<?php echo $NumOfID; ?>", type:""},
			...
			{id:"maquinaria_crear_factura_proveedor3<?php echo $NumOfID; ?>", type:""},
			...
			{id:"maquinaria_crear_observaciones<?php echo $NumOfID; ?>", type:""},
		];
		...
		EnableDisableJSON = [
			...
			{id:"maquinaria_crear_partes_problema<?php echo $NumOfID; ?>", type:""},
			{id:"maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>", type:""},
			{id:"maquinaria_crear_partes_add<?php echo $NumOfID; ?>", type:"jqxButton"},
			{id:"maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>", type:"jqxGrid"},
			//
			{id:"maquinaria_crear_codigo1<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			{id:"maquinaria_crear_producto1<?php echo $NumOfID; ?>", type:"jqxComboBox"},
			...
			if (ClienteLoaded == true)
			{
				...
				var GetValuesAdapter = new $.jqx.dataAdapter(GetValuesSource,{
					...
					loadComplete: function ()
					{
						...
						$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('clear');
						...
						$("#maquinaria_crear_estado<?php echo $NumOfID; ?>").val(records[0]["Estado_Maquina"]);
						$("#maquinaria_crear_operador<?php echo $NumOfID; ?>").val(records[0]["Operador"]);
						$("#maquinaria_crear_mecanico<?php echo $NumOfID; ?>").val(records[0]["Mecanico"]);
						...
						$("#maquinaria_crear_observaciones<?php echo $NumOfID; ?>").val(records[0]["Observaciones"]);
						...
						if (records[0]["Items"].length > 0)
						{
							...
							datarow.reverse();
							$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid("addrow", null, datarow, "first");
						}
	...
	$("#maquinaria_crear_estado<?php echo $NumOfID; ?>").jqxComboBox(
	{
		theme: mytheme,
		width: 150,
		height: 20,
	...
	var NominaDataAdapter = new $.jqx.dataAdapter(NominaSource,
	{
		...
		{
			$("#maquinaria_crear_operador<?php echo $NumOfID; ?>").jqxComboBox({source: records});
			$("#maquinaria_crear_mecanico<?php echo $NumOfID; ?>").jqxComboBox({source: records});
		}
	});
	
	$("#maquinaria_crear_operador<?php echo $NumOfID; ?>").jqxComboBox(
	{
		theme: mytheme,
		width: 225,
		height: 20,
	...
	$("#maquinaria_crear_mecanico<?php echo $NumOfID; ?>").jqxComboBox(
	{
		theme: mytheme,
		width: 260,
		height: 20,
	...
	$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox(
	{
		theme: mytheme,
	...
	$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").on("change", function (event)
	{
		if (event.args)
		{
			//
		...
		{
			var item_value = $("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
			if (item_value)
			{
				$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('clearSelection');
			}
			else
			{
				var value = $("#maquinaria_crear_partes<?php echo $NumOfID; ?>").val();
				
				var item = $("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('getItems');
				for (var i = 0; i < item.length; i++)
				{
					if (item[i].label == value)
					{
						$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('selectItem', item[i].value);
						return;
					}
				}
				$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('clearSelection');
	...
	$("#maquinaria_crear_partes_add<?php echo $NumOfID; ?>").jqxButton({
		theme: mytheme, 
		template: "success", 
		width: 55,
		height: 50
	});
	$("#maquinaria_crear_partes_add<?php echo $NumOfID; ?>").on("click", function ()
	{
		var Parte = $("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Problema = $("#maquinaria_crear_partes_problema<?php echo $NumOfID; ?>").val();
		var Diagnostico = $("#maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>").val();
		
		if (!Parte)
		{
			Alerts_Box("Favor Ingresar la Parte.", 3);
			WaitClick_Combobox("maquinaria_crear_partes<?php echo $NumOfID; ?>");
			return;
		}
		...
		if (Problema == "")
		{
			...
			WaitClick_Input("maquinaria_crear_partes_problema<?php echo $NumOfID; ?>");
			return;
		}
		...
		/*if (Diagnostico == "")
		{
			...
			WaitClick_Input("maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>");
			return;
		}*/
		
		//var datainfo = $("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid("getdatainformation");
		...
		$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid("addrow", null, datarow);
		$("#maquinaria_crear_partes<?php echo $NumOfID; ?>").jqxComboBox('clearSelection');
		$("#maquinaria_crear_partes_problema<?php echo $NumOfID; ?>").val("");
		$("#maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>").val("");
	});
	
	$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid(
	{
		theme: mytheme,
		width: 930,
		autoheight: true,
		...
		[
			{
				...
				{
					var selectedrowindex = $("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('getselectedrowindex');
					var rowscount = $("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('getdatainformation').rowscount;
					if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
						var id = $("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('getrowid', selectedrowindex);
						$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('deleterow', id);
					}
				}
			},
	...
	$("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('localizestrings', localizationobj);
	...
	function Crear()
	{
		...
		var Estado = $("#maquinaria_crear_estado<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Operador = $("#maquinaria_crear_operador<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Mecanico = $("#maquinaria_crear_mecanico<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Clasificacion = $("#maquinaria_crear_clasificacion<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Tipo = $("#maquinaria_crear_tipo<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Motivo = $("#maquinaria_crear_motivo<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		var Diagnostico = $("#maquinaria_crear_diagnostico<?php echo $NumOfID; ?>").jqxComboBox('getSelectedItem');
		
		if (!Estado)
		{
			Alerts_Box("Debe Seleccionar un Estado.", 3);
			WaitClick_Combobox("maquinaria_crear_estado<?php echo $NumOfID; ?>");
			Locked = false;
			return;
		}
		...
		if (!Operador)
		{
			...
			WaitClick_Combobox("maquinaria_crear_operador<?php echo $NumOfID; ?>");
			Locked = false;
			return;
		}
		...
		if (!Mecanico)
		{
			...
			WaitClick_Combobox("maquinaria_crear_mecanico<?php echo $NumOfID; ?>");
			Locked = false;
			return;
		}
		...
		myarray["Observaciones"] = $("#maquinaria_crear_observaciones<?php echo $NumOfID; ?>").val();
		MainArray[0] = myarray;
		...
		{
			var array = {};
			var currentRow = $("#maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>").jqxGrid('getrowdata', i);
	...
	$("#maquinaria_crear_imprimir<?php echo $NumOfID; ?>").bind('click', function ()
	{
		...
		window.open("imprimir/maquinaria.php?Interno="+$("#maquinaria_crear_ord_reparacion<?php echo $NumOfID; ?>").val()+"", "", "width=830, height=600, menubar=no, titlebar=no");
	});
...
<div id="Parte1">
	<table cellpadding="2" cellspacing="1" style="margin-bottom:15px;">
		...
		<tr>
			...
			<td>
				<div id="maquinaria_crear_estado<?php echo $NumOfID; ?>"></div>
			</td>
			<td style="padding-right:40px;">
				Operario
			</td>
			<td>
				<div id="maquinaria_crear_operador<?php echo $NumOfID; ?>"></div>
			</td>
			<td>
				Mecánico
			</td>
			<td>
				<div id="maquinaria_crear_mecanico<?php echo $NumOfID; ?>"></div>
			</td>
		</tr>
		<tr>
			<td>
	...
	<table cellpadding="2" cellspacing="1" style="margin-bottom:15px;">
		...
		<tr>
			<td style="vertical-align:-webkit-baseline-middle;">
				<div id="maquinaria_crear_partes<?php echo $NumOfID; ?>"></div>
			</td>
			<td>
				<textarea rows="3" cols="47" id="maquinaria_crear_partes_problema<?php echo $NumOfID; ?>" maxlength="200" style="resize:none;"></textarea>
			</td>
			<td>
				<textarea rows="3" cols="47" id="maquinaria_crear_partes_diagnostico<?php echo $NumOfID; ?>" maxlength="200" style="resize:none;"></textarea>
			</td>
			<td>
				<input type="button" id="maquinaria_crear_partes_add<?php echo $NumOfID; ?>" value="Añadir"/>
			</td>
		</tr>
	</table>
	<div id="maquinaria_crear_partes_items_grid<?php echo $NumOfID; ?>"></div>
</div>
<!-- PART 2 -->
<div id="Parte2">
	<table cellpadding="1" cellspacing="0" style="margin-bottom:15px;">
		...
		<tr>
			<td rowspan="3" style="padding:0px;">
				<textarea rows="5" cols="32" id="maquinaria_crear_causa<?php echo $NumOfID; ?>" maxlength="200" style="resize:none;"></textarea>
			</td>
			<td rowspan="3" style="padding:0px;">
				<textarea rows="5" cols="32" id="maquinaria_crear_procedimiento<?php echo $NumOfID; ?>" maxlength="200" style="resize:none;"></textarea>
			</td>
			<td rowspan="3" style="padding:0px;">
				<textarea rows="5" cols="32" id="maquinaria_crear_observaciones<?php echo $NumOfID; ?>" maxlength="200" style="resize:none;"></textarea>
			</td>
