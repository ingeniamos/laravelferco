...
$(document).ready(function ()
{
	...
	var Body = document.getElementById("Inicio_Requerimientos");
	var Times = 0;
	var Refresh = 0;
	var Hide = 0;
	...
	$("#inicio_requerimientos_items_grid").jqxGrid(
	{
		theme: mytheme,
		width: 1000,
		autoheight: true,
	...
	$("#inicio_requerimientos_items_grid").jqxGrid('localizestrings', localizationobj);*/
	
	function LoadValues()
	{
		return;
		GridSource.url = "modulos/datos.php";
		GridSource.data = {"Inicio_Requerimientos":true};
		var GridDataAdapter = new $.jqx.dataAdapter(GridSource);
		$("#inicio_requerimientos_items_grid").jqxGrid({source: GridDataAdapter});
	}
...
<!-- PART 1 -->
<div id="Parte1">
	<div id="inicio_requerimientos_items_grid"></div>
</div>
