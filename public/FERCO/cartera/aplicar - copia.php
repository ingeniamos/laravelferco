...
$(document).ready(function ()
{
	...
	$("#cartera_aplicar_cliente").bind('change', function (event) {
		...
		{
			ID_Cliente = "";
			$("#cartera_aplicar_cliente").jqxComboBox('clearSelection');
			$("#cartera_aplicar_cliente_ID").jqxComboBox('clearSelection');
			Cargar_Valores();
		}
	});
	$("#cartera_aplicar_cliente").bind('select', function (event) {
		if (event.args) {
			ID_Cliente = event.args.item.value;
			clearTimeout(Timer);
	...
	$("#cartera_aplicar_cliente_ID").bind('select', function (event) {
		if (event.args) {
			ID_Cliente = event.args.item.value;
			clearTimeout(Timer);
			Timer = setTimeout(function(){
